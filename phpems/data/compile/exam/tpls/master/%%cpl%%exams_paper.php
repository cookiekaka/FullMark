...
<meta name="title" content="满分直播题库系统">
<meta name="description" content="满分直播题库系统">
<meta name="keywords" content="满分直播题库系统">
<meta name="apple-mobile-web-app-capable" content="yes" />
<title>满分直播题库系统</title>
...
<div class="row-fluid">
 ...
 $qid++; ?>
				...
				<?php shuffle($this->tpl_var['sessionvars']['examsessionquestion']['questions'][$quest['questid']]);; ?>
				<?php shuffle($this->tpl_var['sessionvars']['examsessionquestion']['questionrows'][$quest['questid']]);; ?>
				<?php } ?>
				<?php $oid++; ?>
				<div id="panel-type<?php echo $quest['questid']; ?>" class="tab-pane<?php if((!$this->tpl_var['ctype'] && $qid == 1) || ($this->tpl_var['ctype'] == $quest['questid'])){ ?> active<?php } ?>">
					<ul class="breadcrumb">
						<li>
							<h5><?php echo $quest['questype']; ?><?php echo $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['questype'][$quest['questid']]['describe']; ?></h5>
						</li>
					</ul>
					<?php $tid = 0; ?>
	                <?php $qnid = 0;
