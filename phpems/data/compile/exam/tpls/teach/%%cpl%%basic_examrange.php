...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-basic&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">考场管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					<a href="index.php?exam-teach-basic&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">考场管理</a>
				</li>
			</ul>
 ...
 $kid++; ?>
				...
				<div class="control-group">
					<label for="basicexam_auto" class="control-label">绑定直播回放试卷：</label>
					<div class="controls">
