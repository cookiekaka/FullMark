...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-rowsquestions&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">题冒题管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					<a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-rowsquestions&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">题冒题管理</a>
				</li>
			</ul>
			<form action="?exam-teach-rowsquestions-modifyquestion" method="post" class="form-horizontal">
...
"; ?><?php } ?></textarea>
				...
				<div class="control-group">
			  		<div class="controls">
				  		<select class="combox" target="isectionselect" refUrl="index.php?exam-teach-questions-ajax-getsectionsbysubjectid&subjectid={value}">
 ...
 $sid++; ?>
				  		...
				  		<select class="combox" id="isectionselect" target="iknowsselect" refUrl="index.php?exam-teach-questions-ajax-getknowsbysectionid&sectionid={value}">
