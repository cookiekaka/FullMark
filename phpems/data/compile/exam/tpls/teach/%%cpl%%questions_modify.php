...
"; ?><?php } ?></textarea>
 ...
 $qid++; ?>
				...
				<div class="control-group" id="selecttext"<?php if($this->tpl_var['questypes'][$this->tpl_var['question']['questiontype']]['questsort'] || $this->tpl_var['questypes'][$this->tpl_var['question']['questiontype']]['questchoice'] == 5){ ?> style="display:none;"<?php } ?>>
				...
				<div class="control-group" id="selectnumber"<?php if($this->tpl_var['questypes'][$this->tpl_var['question']['questiontype']]['questsort'] || $this->tpl_var['questypes'][$this->tpl_var['question']['questiontype']]['questchoice'] == 5){ ?> style="display:none;"<?php } ?>>
